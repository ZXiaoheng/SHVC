            ...
            int start,int frame_number,bool b_ti,bool b_si)
{
    ...
    char cfilename[30];
    strcpy(cfilename, strPath.c_str());
        fYUV = fopen(cfilename, "r");
...
int main(int argc, char* argv[])
{
   ...
   string filename="Volleyball_1920x1080.yuv";
    int width=1920,height=1080,pixfmt=0;
    int start=0,frame_number=250;
